...
<body>
	<div class="container">
		<div class="info-section">
			<img src="css/image/black_dog.png" alt="Black Dog">
			<div class="text-content">
				<p class="speech-bubble">เราชื่อหมาดำน้ำ แล้วเธอล่ะ ฉันขอรู้จักเธอได้มั้ย ฮิฮิฮิ</p>
			</div>
		</div>
		<div class="wrapper">
			<h1>Login</h1>
	...
	<?php if ($isLoggedIn): ?>
	<div id="successModal" class="success-box">
